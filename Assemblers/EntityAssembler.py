...
class EntityAssembler(object):
    ...
    def setExtractorList(self, aList):
        ...
        for extractor in self.extractorList:
            if extractor!= "DrugnameMetamapExtractor":
    ...
    def xmlWriterHelper(self, element, root):
        try:
            elem = ET.Element(element(self.entityName))
        except Exception:
            pass
            # print 'list object have no attr entityName'
        ...
        try:
         if element.charOffset[0]:
            ...
            pass
            # print 'list obj have no attr charOffset'
