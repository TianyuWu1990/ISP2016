...
class SVMv1DrugNameExtractor(object):
    ...
    def findEntity(self):
        ...
        for label in predictions:
            if label == 1:
                drugNameElementList.append(DrugnameElement(self.vectors[offset][0][0],
                                                           [self.vectors[offset][0][1], self.vectors[offset][0][2]],
                                                           "SVMv1DrugNameExtractor", "DRUGNAME"))
            offset += 1
